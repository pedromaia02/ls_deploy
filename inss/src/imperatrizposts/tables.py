...
from .models import ImperatrizPosts

class PostsTable(tables.Table):

    actions = tables.TemplateColumn("<a href=/inssimperatriz/{{record.id}}>Detalhes</a>  -  <a href=/inssimperatriz/{{record.id}}/edit>Modificar</a>  -  <a href=/inssimperatriz/{{record.id}}/delete onclick='return confirm(\"Confima deletar o item selecionado?\")'>Excluir</a>", orderable=False)
