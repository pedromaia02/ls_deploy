...
from .models import NatalPosts

class PostsTable(tables.Table):

    actions = tables.TemplateColumn("<a href=/inssnatal/{{record.id}}>Detalhes</a>  -  <a href=/inssnatal/{{record.id}}/edit>Modificar</a>  -  <a href=/inssnatal/{{record.id}}/delete onclick='return confirm(\"Confima deletar o item selecionado?\")'>Excluir</a>", orderable=False)
