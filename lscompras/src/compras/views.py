...
from .models import Compras,Contratos,Comentarios,ComentarioCompras
...
def post_detail(request, id=None):
	...
	if form.is_valid():
		...
		ComentarioCompras(id_compra=id,id_comentario=instance.id,user="Escritório",anexo=instance.anexo,).save()
